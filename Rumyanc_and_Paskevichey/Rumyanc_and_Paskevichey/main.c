/*
 * Rumyanc_and_Paskevichey.c
 *
 * Created: 28.07.2021 17:31:08
 * Author : user
 */ 
...
uint8_t led1=255, led2=255, led3=255, led4=255, led5=255, led6=255, led7=255, led8=255, flor=0, roof=0;                 //скважность ШИМ в программе
